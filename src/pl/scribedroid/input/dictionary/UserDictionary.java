...
public class UserDictionary extends Dictionary {
	...
	private static final String SELECTION = android.provider.UserDictionary.Words.WORD + " LIKE ? AND ((" +
											android.provider.UserDictionary.Words.LOCALE+" IS NULL) or ("+
											android.provider.UserDictionary.Words.LOCALE+"=?))";
	private static final String EXACT_SELECT = android.provider.UserDictionary.Words.WORD + " = ? AND ((" +
												android.provider.UserDictionary.Words.LOCALE+" IS NULL) or ("+
												android.provider.UserDictionary.Words.LOCALE+"=?))";
	...
	public List<String> getSuggestions(String prefix) {
		Cursor suggestions= context.getContentResolver().query(URI, COLUMNS, SELECTION, new String[]{prefix+"%",locale.toString()}, ORDER);
	...
	public boolean isValid(String word) {
		Cursor suggestions= context.getContentResolver().query(URI, COLUMNS, EXACT_SELECT, new String[]{word,locale.toString()}, null);
