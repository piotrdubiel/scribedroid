...
public class DictionaryDbHelper extends SQLiteOpenHelper {
	...
	public static String[] ALL_COLUMNS = { COLUMN_WORD, COLUMN_FREQUENCY };
	...
	private static final String DATABASE_CREATE = "create table if not exists " + TABLE_WORDS
			+ " (" + COLUMN_WORD + " text not null, " + COLUMN_FREQUENCY
			+ " integer not null);";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.w(DictionaryDbHelper.class.getName(), "Upgrading database from version "
				+ oldVersion
				+ " to "
				+ newVersion
	...
	private void copyDatabase(File db_file) {
		Log.v("Database", " COPYING DATABASE FROM ASSETS...");
		try {
